  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center p-4 sm:p-6 md:p-8 lg:p-12 w-full min-h-screen">
        ...
        >
          <div>
            ...
            <div className="flex justify-center">
              <button
                className="w-1/5 m-1 font-bold text-white bg-red-600 border p-2"
                onClick={closeModal}
              >
                Cerrar
              </button>
              <button
                className="w-1/5 m-1 font-bold text-white bg-green-600 border p-2"
                onClick={closeModal}
              >
                Añadir
              </button>
        ...
        >
          <div>
            ...
            <div className="flex justify-center">
              ...
              <button
                className="w-1/5 m-1 font-bold text-black bg-yellow-400 border p-2"
                onClick={closeEditModal}
              >
                Editar
              </button>
        ...
        <dialog
          ref={deleteModalRef}
          className="border-4 border-black bg-azulIntegradorClaro w-full max-w-md p-4 sm:w-1/2 sm:max-w-lg"
        >
          <div className="flex flex-col items-center">
            <ModalEliminar currentPage={currentPage} />
            <div className="flex justify-center w-full mt-4 space-x-2">
              <button
                className="w-full sm:w-1/3 font-bold text-white bg-red-600 rounded-lg p-2"
        ...
        {notification && (
          <div className="fixed bottom-4 right-4 bg-green-500 text-white p-4 rounded">
            {notification}
            <button className="ml-4" onClick={handleCloseNotification}>
              Cerrar
            </button>
          </div>
        )}
